let tabella:any = document.getElementById('miky')
class Negozio {
    id: number
    codprod: number
    collezione: string
...
let testina:string[] = ['id', 'codprod', 'collezione', 'capo', 'modello', 'quantita', 'colore', 'prezzoivaesclusa', 'prezzoivainclusa', 'disponibile', 'saldo']
testina.forEach(x => {
